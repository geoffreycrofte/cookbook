...
parties:
  - nom: Les aiguillettes panées
    ...
    etapes:
      - texte: |-
          Si besoin, couper le poulet en petites pièces égales pour remplacer les aiguillettes.
          Broyer les corn flakes pour obtenir une panure inégale.
        temperature: null
        duree: null
        image: 22175.jpg
      ...
      - texte: |-
          Enrober chaque pièce de poulet de maïzena jusqu'à ce qu'elle soit blanche, la tremper ensuite dans l'œuf battu pour bien la couvrir, puis l'écraser dans les corn flakes pour faire adhérer la panure.
          Renouveler l'opération pour toutes les pièces. Quand les corn flakes du bol deviennent trop compacts, retirer l'excédent et ajouter un nouveau tiers de corn flakes.
        temperature: null
        duree: null
        image: ./step-02.jpg
